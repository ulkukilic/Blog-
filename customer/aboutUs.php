...
<div class = "aboutUs" >
<section class="bg-white dark:bg-gray-900 py-16 mt-20 ">
  <div class="max-w-7xl mx-auto px-10 lg:px-8 grid lg:grid-cols-2 gap-15 items-center ">
    <div>
      <h2 class="text-4xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-5xl">
        About Us
      </h2>
      <p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400">
        Since 2000, we’ve been dedicated to creating the best digital experiences. 
        We love what we do and are proud to have connected thousands of people and ideas. 
        Our team works with passion and joy — and we’re excited for what’s ahead.
      </p>
    </div>

    <div class="grid grid-cols-2 gap-6">
      <img src="/Blog-/img/about1.png" alt="Team working"
        class="rounded-xl shadow-lg object-cover w-full h-48" />
      <img src="/Blog-/img/blog2.png" alt="Collaboration"
        class="rounded-xl shadow-lg object-cover w-full h-48" />
      <img src="/Blog-/img/blog3.png" alt="Team meeting"
        class="rounded-xl shadow-lg object-cover w-full h-48" />
      <img src="/Blog-/img/about2.png" alt="Discussion"
        class="rounded-xl shadow-lg object-cover w-full h-48" />
    </div>
...
<div class="workWithUs">
 <div class="relative isolate overflow-hidden bg-white py-24 sm:py-32 dark:bg-gray-900">
  ...
  <div aria-hidden="true" class="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl">
    <div style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)" class="aspect-1097/845 w-274.25 bg-linear-to-tr from-[#ff4694] to-[#776fff] opacity-15 dark:opacity-20"></div>
  </div>
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      <h2 class="text-5xl font-semibold tracking-tight text-gray-200 sm:text-7xl dark:text-white">Work with us</h2>
      <p class="mt-8 text-lg font-medium text-pretty text-gray-200 sm:text-xl/8 dark:text-gray-300">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat commodo. Elit sunt amet fugiat veniam occaecat fugiat.</p>
    </div>
    <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 text-base/7 font-semibold text-gray-200 sm:grid-cols-2 md:flex lg:gap-x-10 dark:text-white">
        <a href="#">Open roles <span aria-hidden="true">&rarr;</span></a>
        <a href="#">Meet our leadership <span aria-hidden="true">&rarr;</span></a>
      </div>
      <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
        <div class="flex flex-col-reverse gap-1">
          <dt class="text-base/7 text-gray-400 dark:text-gray-300">Offices worldwide</dt>
          <dd class="text-4xl font-semibold tracking-tight text-gray-400 dark:text-white">12</dd>
        </div>
        <div class="flex flex-col-reverse gap-1">
          <dt class="text-base/7 text-gray-400 dark:text-gray-300">Full-time colleagues</dt>
          <dd class="text-4xl font-semibold tracking-tight text-gray-400 dark:text-white">300+</dd>
        </div>
        <div class="flex flex-col-reverse gap-1">
          <dt class="text-base/7 text-gray-400 dark:text-gray-300">Hours per week</dt>
          <dd class="text-4xl font-semibold tracking-tight text-gray-300 dark:text-white">40</dd>
        </div>
        <div class="flex flex-col-reverse gap-1">
          <dt class="text-base/7 text-gray-400 dark:text-gray-300">Paid time off</dt>
          <dd class="text-4xl font-semibold tracking-tight text-gray-300 dark:text-white">Unlimited</dd>
        </div>
      </dl>
    </div>
  </div>
